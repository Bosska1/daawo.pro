...
import { ArrowLeft, Maximize, Minimize, RefreshCw, Volume2, VolumeX, Loader2, PlayCircle } from 'lucide-react';
  ...
  const handleRefresh = () => {
    ...
    if (iframeRef.current && streamSources[currentSourceIndex]) {
      ...
      setTimeout(() => {
        ...
        loadingTimeoutRef.current = setTimeout(() => setIsLoading(false), 1200);
      }, 50);
    }
  };
